...
const routes = [
    ...
    {
        path: 'agregar',
        loadChildren: () => __webpack_require__.e(/*! import() | pages-agregar-agregar-module */ "agregar-agregar-module").then(__webpack_require__.bind(null, /*! ./pages/agregar/agregar.module */ "./src/app/pages/agregar/agregar.module.ts")).then(m => m.AgregarPageModule)
    }
];
...
module.exports = __webpack_require__(/*! F:\Backup\Proyectos Angular\Deseos Angular\deseos\src\main.ts */"./src/main.ts");
